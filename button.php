        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<h5><center>Are you sure to delete <strong><?php echo ucwords($row['tasking']); ?></strong> from the list?</center></h5> 
                </div> 
				</div>
            ...
            <div class="modal-content">
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['userid']; ?>">
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="tasking" class="form-control" value="<?php echo $erow['tasking']; ?>">
						</div>
					</div>
